...
if __name__ == '__main__':
    ...
    print("Here we provide information about the analysis of the simulated images using the IRMAD method\n", file=f)
    ...
    imageio.imwrite('IRMAD_simul_im.tiff', k_means_bcm)
    imageio.imwrite('IRMAD_simul_im.png', k_means_bcm)
    toc = time.time()
