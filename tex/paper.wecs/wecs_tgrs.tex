...
%%%RGN: não foi definido/motivado o que é screening
\textcolor{orange}{However, an application of screening ideas on wavelet coefficients is still a novel approach in change detection literature, and we show it has an interesting potential to provide good results even with simple algorithms.}
...
\mbox{
\subfigure[$m=1$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/X_1.png}\label{figImgSentinel2015}} 
\subfigure[$m=30$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/X_30.png}\label{figImgSentinel2017}}
}

\mbox{
\subfigure[$m=59$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/X_59.png}\label{figImgSentinel2015}} 
\subfigure[$\overline{\mathcal{I}}$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/X_mean.png}\label{figImgSentinel2017}}
}
...
\mbox{
\subfigure[WECS -- $\vR$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/imageWECS.png}\label{figImgSentinel2015}} 
\subfigure[ECS -- $\widetilde{\vR}$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/imageECS.png}\label{figImgSentinel2017}}
}

\subfigure[TAAD -- $\vA$]{\includegraphics[width=0.23\textwidth]{../../qgis/maps/imageTAAD.png}\label{figImgSentinelROIs}}

\caption{The ``tendency of change'' matrices $\vR$, $\widetilde{\vR}$ and $\vA$  assigned to the WECS, ECS and TAAD methods, respectively. The values are scaled to $[0,1]$.}\label{figImageMethods}
\end{figure}
...
%see that WECS provides more accurate results than the other two methods (c.f. Table \ref{tabAccExpSentinel}).
